	...
	static std::string GetTimeLength(long unitCnt, const size_t TimeUnit)
	{
		if (unitCnt > 0)
		{
			...
			switch (maxElementIdx)
			{
				...
				case 1: return timeElement[0] + " " + "e" + " " + timeElement[1];
				case 2: return timeElement[0] + ", " + timeElement[1] + " " + "e" + " " + timeElement[2];
				case 3: return timeElement[0] + ", " + timeElement[1] + ", " + timeElement[2] + " " + "e" + " " + timeElement[3];
				case 4: return timeElement[0] + ", " + timeElement[1] + ", " + timeElement[2] + ", " + timeElement[3] + " " + "e" + " " + timeElement[4];
				case 5: return timeElement[0] + ", " + timeElement[1] + ", " + timeElement[2] + ", " + timeElement[3] + ", " + timeElement[4] + " " + "e" + " " + timeElement[5];
				case 6: return timeElement[0] + ", " + timeElement[1] + ", " + timeElement[2] + ", " + timeElement[3] + ", " + timeElement[4] + ", " + timeElement[5] + " " + "e" + " " + timeElement[6];
			}
		}
