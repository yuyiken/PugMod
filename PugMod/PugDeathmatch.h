...
public:
	...
	void AddSpawn(vec3_t Vecs, vec3_t Angles, vec3_t VAngles, int Team);
	void AddItem(std::string Alias, std::string Label, bool Enable, bool Bot);
	...
	void EquipRandom(CBasePlayer* Player, InventorySlotType Slot);
...
private:
	...
	std::vector<WeaponSlotInfo> m_Items;
