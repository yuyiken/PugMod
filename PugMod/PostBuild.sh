...
hldsRunCommand="./hlds_run -console -game cstrike -debug -port 27020 -pingboost 3 -steam -master -secure -bots -timeout 3 +ip $ipAddress +map de_inferno +maxplayers 32 +sys_ticrate 1000";
